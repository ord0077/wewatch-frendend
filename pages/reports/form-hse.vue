...
<td>
<v-text-field v-model="l1.staff_numbers" :rules="Rules" label="write your answer" required></v-text-field>
</td>
<td>  
<v-text-field v-model="l1.shift_pattern" :rules="Rules" label="write your answer" required></v-text-field>
</td>
<td>  
<v-text-field v-model="l1.daily_man_hours" :rules="Rules" label="write your answer" required></v-text-field>
</td>
<td>
...
<td>    
<v-text-field v-model="l1.staff_numbers" :rules="Rules" required label="write your answer"></v-text-field> 
</td>
<td>    
...
<td>    
<v-text-field v-model="total_man_days" :rules="Rules" required label="write your answer"></v-text-field> 
</td>
</tr>
...
<td>    
<v-text-field v-model="total_man_hours" :rules="Rules" required label="write your answer"></v-text-field> 
</td>
</tr>
...
<td>    
<v-text-field v-model="total_lost_work_hours" :rules="Rules" required label="write your answer"></v-text-field> 
</td>
...
data: () => ({
        ...
        project_id :1,
        user_id :"",
        description_confidential : "test",
        daily_situation_summary : "test",
        project_key_meeting : "test",
        toolbox_talk : "test",
        procurement_request : "test",
        red_flag : "test",
        weather : "test" ,
        wind_strength : "test",
        weather_wind_remarks : "test" ,
        design_build_time : "test",
        daily_operation_man_hour : "test",
        design_time_hour_remarks : "test",

        total_man_days : 10,
        total_man_hours : 10,
        total_lost_work_hours : 10,
  
        loop1 : [{contractor_name : 'test', staff_numbers : 'test', shift_pattern : 'test', daily_man_hours : 'test', }],
        loop2 : [{type_contractors : 'test', staff_numbers : 'test', shift_pattern : 'test'}],
        loop3 : [{activites : 'test', occurrence : '1', remarks : 'test'}],
        loop4 : [{project_health_activites : 'test', project_health_occurrence : '1', project_health_remarks : 'test'}],
        loop5 : [{hazard_identify_activites : 'test', hazard_identify_occurrence : '1', hazard_identify_remarks : 'test'}],
        loop6 : [{near_miss_activites : 'test', near_miss_occurrence : '1', near_miss_remarks : 'test'}],
        loop7 : [{covid_compliance_activites : 'test', covid_compliance_occurrence : '1', covid_compliance_remarks : 'test'}],
        loop8 : [{email : 'test'}],
